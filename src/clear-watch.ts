...
export async function clearWatch<TDeepClient extends DeepClientInstance>(this: GeolocationDecorator<TDeepClient>, options: ClearWatchOptions): ClearWatchResult {
